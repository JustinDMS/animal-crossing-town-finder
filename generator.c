...
static uint8_t l_mRF_step3_blocks3[BLOCK_TOTAL_NUM] = {
...
static uint8_t l_mRF_step3_blocks7[BLOCK_TOTAL_NUM] = {
  0x05, 0x01, 0x00, 0x00, 0x00, 0x00, 0x08,
  0x09, 0x0d, 0x0c, 0x0b, 0x0c, 0x0c, 0x0a,
...
static uint8_t l_mRF_step3_blocks7R[BLOCK_TOTAL_NUM] = {
...
static uint8_t l_mRF_step3_blocks8[BLOCK_TOTAL_NUM] = {
  0x05, 0x00, 0x00, 0x00, 0x00, 0x01, 0x08,
  0x09, 0x0c, 0x0c, 0x0b, 0x0c, 0x0d, 0x0a,
...
static uint8_t l_mRF_step3_blocksB[BLOCK_TOTAL_NUM] = {
...
static uint8_t l_mRF_step3_blocksBR[BLOCK_TOTAL_NUM] = {
...
static uint8_t l_mRF_step3_blocksE[BLOCK_TOTAL_NUM] = {
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08,
  0x09, 0x0c, 0x0d, 0x0b, 0x0c, 0x0c, 0x0a,
  0x3d, 0x13, 0x28, 0x0e, 0x12, 0x0f, 0x3e,
  0x02, 0x15, 0x16, 0x0f, 0x10, 0x27, 0x04,
...
static uint8_t l_mRF_step3_blocksER[BLOCK_TOTAL_NUM] = {
  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08,
  0x09, 0x0c, 0x0c, 0x0b, 0x0d, 0x0c, 0x0a,
  0x3d, 0x0f, 0x13, 0x0e, 0x28, 0x12, 0x3e,
  0x02, 0x27, 0x15, 0x0f, 0x16, 0x10, 0x04,
...
static uint8_t l_mRF_step3_blocksF[BLOCK_TOTAL_NUM] = {
  0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x08,
  0x09, 0x0c, 0x0d, 0x0b, 0x0c, 0x0c, 0x0a,
...
static uint8_t l_mRF_step3_blocksFR[BLOCK_TOTAL_NUM] = {
  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x08,
  0x09, 0x0c, 0x0c, 0x0b, 0x0d, 0x0c, 0x0a,
...
static uint8_t* l_mRF_step3_blockss[10] = {
  l_mRF_step3_blocks3,
  l_mRF_step3_blocks7,
...
int generate() {
    RANDOM(5) | 0x2800; // Fruit
    RANDOM(3); // BG Texture
    RANDOM(2); // ?? I don't know where this extra call is in the source code but it works
    ...
    while (perfect_bit != (perfect_bit & bit)) {
        ...
        if (step_mode == 1) {
            uint8_t* src = l_mRF_step3_blockss[RANDOM(ARRAY_COUNT(l_mRF_step3_blockss))];
